#ifndef CPP2_S21_CONTAINERS_1_SRC_S21_CONTAINERSPLUS_ARRAY_S21_ARRAY_H
#define CPP2_S21_CONTAINERS_1_SRC_S21_CONTAINERSPLUS_ARRAY_S21_ARRAY_H
...
namespace s21
{
  ...
  public:
    ...
    array(std::initializer_list<value_type> const &items); // Конструктор с инициализатором
    ...
    const_reference at(size_type pos) const; // константный доступ по индексу с проверкой
    ...
    const_reference operator[](size_type pos) const; // константный доступ по индексу
